...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-DWcHyHOy.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-PUezBeqB.mjs");
...
var manifest = { "cf83fb884f9a20eadc84a4d6b0cdfb55e83a440a27a08690eea58b3400fc156a": {
	functionName: "generateDocumentation_createServerFn_handler",
	importer: () => import("./docs.functions-lWediJZj.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-uv9BLXqx.mjs").then((n) => n.t),
		import("./start-D57mqI8S.mjs"),
